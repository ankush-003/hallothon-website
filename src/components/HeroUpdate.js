    ...
    <div className="overflow-hidden">
      <div className="hidden sm:block">
        <div className="hero overflow-hidden">
          <div className="herogrid">
            ...
            <animated.div className="year-bar" style={hallothonInOutStyle}>
              <span>2023</span>
            </animated.div>
      ...
      <div className="block sm:hidden h-screen">
        <div class="mob__grid">
          ...
          <animated.div style={hallothonMidLeftStyle} class="mob__hallo">
            HALLO
          </animated.div>
          <animated.div style={hallothonMidRightStyle} class="mob__thon">
            THON
          </animated.div>
          ...
          <animated.div style={hallothonInOutStyle} className="mob__skull">
            <Skull />
          </animated.div>
